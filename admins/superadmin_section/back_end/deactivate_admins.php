...
$sqlUpdate = "UPDATE admins SET status = 'deactivated'";
...
if ($resultUpdate === TRUE) {
    ...
    if ($result_insertReports->num_rows > 0) {
        ...
        if ($result_Superadminreports->num_rows > 0) {
            ...
            $sql_reports = "INSERT INTO `$audittrial_reportbatch`(`reports`, `account`, `date/time`) VALUES ('Deactivated all the admins','$superadmin','$currentDateFormatted/$currentTime12Hour')";
