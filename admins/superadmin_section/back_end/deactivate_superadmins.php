...
$sqlUpdate = "UPDATE super_admin SET status = 'deactivated' WHERE status = 'activated'";
...
if ($resultUpdate === TRUE) {
    ...
    if ($result_insertReports->num_rows > 0) {
        ...
        if ($result_Superadminreports->num_rows > 0) {
            ...
            $sql_reports = "INSERT INTO `$audittrial_reportbatch`(`reports`, `account`, `date/time`) VALUES ('Deactivated all the superadmins','$superadmin','$currentDateFormatted/$currentTime12Hour')";
