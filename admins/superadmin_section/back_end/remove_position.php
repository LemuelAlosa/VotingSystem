    ...
    if ($result_select->num_rows > 0) {
        ...
        if ($result_insertReports->num_rows > 0) {
            ...
            if ($result_Superadminreports->num_rows > 0) {
                ...
                $sql_reports = "INSERT INTO `$audittrial_reportbatch`(`reports`, `account`, `date/time`) VALUES ('Position $position has been removed.','$superadmin','$currentDateFormatted/$currentTime12Hour')";
