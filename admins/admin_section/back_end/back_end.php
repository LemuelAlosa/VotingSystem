                ...
                if ($conn->query($sql) === TRUE) {
                    ...
                    if ($result_insertReports->num_rows > 0) {
                        ...
                        if ($result_Adminreports->num_rows > 0) {
                            ...
                            $sql_reports = "INSERT INTO `$audittrial_reportbatch`(`reports`, `account`, `date/time`) VALUES ('Added new candidate named $firstname $lastname as $position.','$admin','$currentDateFormatted/$currentTime12Hour')";
