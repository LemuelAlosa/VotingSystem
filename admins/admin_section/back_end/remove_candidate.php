    ...
    if ($result_select->num_rows > 0) {
        ...
        if ($result_insertReports->num_rows > 0) {
            ...
            if ($result_Adminreports->num_rows > 0) {
                ...
                $sql_reports = "INSERT INTO `$audittrial_reportbatch`(`reports`, `account`, `date/time`) VALUES ('Candidate $Firstname $Lastname / $Position has been removed from candidate list.','$admin','$currentDateFormatted/$currentTime12Hour')";
